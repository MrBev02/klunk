...
function shape(spec: PaperPromptSpec): string {
  return [
    ...
    '  questionType   one of: multiple_choice, short_answer, extended_response,',
    '                 true_false, table, drawing',
    ...
    '',
    '    choices        multiple_choice: the options in order, as',
    '                   [ { "text": "..." } ]',
    ...
    '',
    '- Use "multiple_choice" only where exactly one option is correct. Where the',
    '  paper says more than one may be selected, or asks the student to match two',
    '  lists, use "short_answer" and put the options or the lists in',
    '  "questionText". A single correct answer would be wrong.',
