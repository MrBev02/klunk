...
A reason that does change what they do stays, compressed:

- Keep: `These are cut from the blank parts of the page, so some will be wrong. Drop anything that is not part of the question.`

That earns its place: it says the cutouts are guesses, which is why they are
being asked to look.
